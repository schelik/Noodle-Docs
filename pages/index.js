        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div>
            <div  onClick={() => setShowModal(true)} className="relative h-52 w-40 border-2 cursor-pointer hover:border-blue-700">
              <img src="https://firebasestorage.googleapis.com/v0/b/noodle-docs.appspot.com/o/docs-blank-googlecolors.png?alt=media&token=0e2d18fe-d9a7-4b53-aa0b-6a506ad23ced" 
              loading="lazy" />
            </div>
